...
@Component({
  ...
  providers: [DataHandlerService, CategoryDAOArray, TaskDAOArray],
})
export class TasksComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @Output() updateTask = new EventEmitter<{
    task: TaskType
    typeAction: (typeof typeAction)[number]
  }>()
  @Output() actionCategory = new EventEmitter<CategoryType>()
  ...
  openEditTaskDialog(task: TaskType): void {
    this.dialog
      .open<EditTaskComponent>(EditTaskComponent, {
        data: [task, 'Edit task'],
        autoFocus: false,
      })
      .afterClosed()
